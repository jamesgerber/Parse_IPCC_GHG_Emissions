function [CO2eq,rawgas]=getEdgarData_2024(ISO,gas,subsector,YYYY);
% getEdgarData_2024 - get data from EDGAR Database - through 2024 
%
% Syntax
%     [CO2eq,rawgas]=getEdgarData_2024(ISO,gas,subsector,YYYY);
...
if isempty(EdgarEmissions_CO2_IPCC1996)
  ...
  %  datadir=DataFilesLocation;
    ...
    load(['~/DataProducts//ext/EDGAR/Feb11_2026/processeddata/EdgarV2025.mat'])
