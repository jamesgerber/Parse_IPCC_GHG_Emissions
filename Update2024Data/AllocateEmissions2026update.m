function [M,rows,cols,A,B,OE,IND,T,E]=AllocateEmissions2026update(ISO,YYYY);
% AllocateEmissionsNFI "no F***ing indirect"
%
% [M,rows,cols,A,B,OE,IND,T,E]=AllocateEmissions2026update(ISO,YYYY)
%
% Helpful syntax:
% [M,rows,cols]=AllocateEmissions2026update(MinxCountriesList,2000);
%
...
buildings=ScaleWithLatestEDGAR(buildings,'buildings',ISO,YYYYold,YYYYnew);
...
otherenergy=ScaleWithLatestEDGAR(otherenergy,'otherenergy',ISO,YYYYold,YYYYnew);
...
%[CO2eqSolidWaste,SolidWaste]=getEdgarData_2024(ISO,'CO2','Incineration and Open Burning of Waste',YYYY);
...
if numel(strmatch(ISO,InMinxNotEdgarList))==1
    ...
    [CO2eqBioTreatSW,CH4BioTreatSW]=getEdgarData_2024(ISO,'CH4','Biological Treatment of Solid Waste',YYYY);
    [CO2eqWastewater,CH4Wastewater]=getEdgarData_2024(ISO,'CH4','Wastewater Treatment and Discharge',YYYY);
    [CO2eqSolidWaste,CH4SolidWaste]=getEdgarData_2024(ISO,'CH4','Solid Waste Disposal',YYYY);
    [CO2eqIncineration,CH4Incineration]=getEdgarData_2024(ISO,'CH4','Incineration and Open Burning of Waste',YYYY);
    [CO2eqBioTreatSW,N2OBioTreatSW]=getEdgarData_2024(ISO,'N2O','Biological Treatment of Solid Waste',YYYY);
    [CO2eqWastewater,N2OWastewater]=getEdgarData_2024(ISO,'N2O','Wastewater Treatment and Discharge',YYYY);
    %[CO2eqSolidWaste,N2OSolidWaste]=getEdgarData_2024(ISO,'N2O','Solid Waste Disposal',YYYY);
    [CO2eqIncineration,N2OIncineration]=getEdgarData_2024(ISO,'N2O','Incineration and Open Burning of Waste',YYYY);
end
...
%% scaling goes in here

industry=ScaleWithLatestEDGAR(industry,'industry',ISO,YYYYold,YYYYnew);
...
% These all get multiplied by the country-level increase in Electricity
% production.
Ratio=ScaleWithLatestEDGAR(1,'electricity',ISO,YYYYold,YYYYnew);
...
transport=ScaleWithLatestEDGAR(transport,'transport',ISO,YYYYold,YYYYnew);
