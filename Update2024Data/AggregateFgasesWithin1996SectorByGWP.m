function dagg=AggregateFgasesWithin1996SectorByGWP(d);
% AggregateFgasesWithin1996SectorByGWP
% d must have a field called tonssubstance

namelist=unique(d.ipcc_code_1996_for_standard_report_name);

global GWPFLAG

for j=1:numel(namelist)
    name=namelist{j};
    ii=strmatch(name,d.ipcc_code_1996_for_standard_report_name);
    ...
    dagg.ipcc_code_1996_for_standard_report_name{j}=name;
